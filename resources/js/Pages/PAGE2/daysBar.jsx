...
export default function DaysBar() {
    ...
    useEffect(() => {
        console.log(datebar.current.childNodes[0].childNodes[1].dataset.date);
    ...
    return (
        ...
        <section class="calandre">
            ...
            <div id="calandre-box" ref={datebar} className="cursor-pointer">
                ...
                <span id="thursday" data-id="3" className="transition-all ease-in-out duration-200 capitalize" onClick={handelSpotPosition}>{(new Date(new Date().setDate(new Date().getDate() + 3)).toLocaleDateString('fr-us', { weekday: 'long' }))}<p id="date" data-date={(new Date(new Date().setDate(new Date().getDate() + 3)).toLocaleDateString('en-us'))} style={{pointerEvents:'none'}}>{(new Date(new Date().setDate(new Date().getDate() + 3)).toLocaleDateString('fr-us',{day:'numeric', month:'long'}))}</p></span>
                <span id="friday" data-id="4" className="transition-all ease-in-out duration-200 capitalize" onClick={handelSpotPosition}>{(new Date(new Date().setDate(new Date().getDate() + 4)).toLocaleDateString('fr-us', { weekday: 'long' }))}<p id="date" data-date={(new Date(new Date().setDate(new Date().getDate() + 4)).toLocaleDateString('en-us'))}style={{pointerEvents:'none'}}>{(new Date(new Date().setDate(new Date().getDate() + 4)).toLocaleDateString('fr-us',{day:'numeric', month:'long'}))}</p></span>
                <span id="saturday" data-id="5" className="transition-all ease-in-out duration-200 capitalize" onClick={handelSpotPosition}>{(new Date(new Date().setDate(new Date().getDate() + 5)).toLocaleDateString('fr-us', { weekday: 'long' }))}<p id="date" data-date={(new Date(new Date().setDate(new Date().getDate() + 5)).toLocaleDateString('en-us'))}  style={{pointerEvents:'none'}}>{(new Date(new Date().setDate(new Date().getDate() + 5)).toLocaleDateString('fr-us',{day:'numeric', month:'long'}))}</p></span>
                <span id="sunday" data-id="6" className="transition-all ease-in-out duration-200 capitalize" onClick={handelSpotPosition}>{(new Date(new Date().setDate(new Date().getDate() + 6)).toLocaleDateString('fr-us', { weekday: 'long' }))}<p id="date" data-date={(new Date(new Date().setDate(new Date().getDate() + 6)).toLocaleDateString('en-us'))} style={{pointerEvents:'none'}}>{(new Date(new Date().setDate(new Date().getDate() + 6)).toLocaleDateString('fr-us',{day:'numeric', month:'long'}))}</p></span>
